...
//		Handler.objects.add(new Wheel(new Transform(new Vector2(-200, -300), new Vector2(100, 100)), 0));
//		for (int y = 0; y < 10; y++) {
//			for (int x = 0; x < 10; x++) {
...
//		}
		...
		tr = new Transform(new Vector2(100, 1000), new Vector2(100000f, 10), Math.toRadians(30));
		Handler.objects.add(new Wall(tr));
	}
