...
public class Handler {
	// Deze class zorgt ervoor dat de tick en render methods van alle objecten goed worden uitgevoerd.
	public static LinkedList<GameObject> objects = new LinkedList<GameObject>();
	
	public void tick() {
		for(GameObject object : objects) {
			// Kijkt of de lijst de huidige state bevat. Als dat niet zo is, moet er ook niets gebeuren.
